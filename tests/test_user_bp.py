import unittest
from app import create_app  # Імпортуємо функцію створення додатку

class FlaskAppTestCase(unittest.TestCase):

    def setUp(self):
        """Налаштування клієнта тестування перед кожним тестом."""
        self.app = create_app()  # Викликаємо create_app() для створення об'єкта app
        self.app.config["TESTING"] = True  # Налаштовуємо конфігурацію
        self.client = self.app.test_client()  # Створюємо клієнта тестування
